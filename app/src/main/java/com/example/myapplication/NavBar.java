...
import com.example.myapplication.medicine.MedicineActivity;
...
public class NavBar extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            getSupportFragmentManager().
                    beginTransaction().replace(R.id.screen_area,new HomeFragment()).commit();
        }
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        }else if (id == R.id.idRiskCalculator) {

            fragment = new Riskcalc_Fragment();
        ...
        }else if (id == R.id.idDietPlan) {

            fragment = new FragmentDietPlan();

        } else if (id == R.id.idFragmentMedia) {
