...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioButtonGender = (RadioButton) findViewById(R.id.radioMale);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()) {
                            ...
                            int btngenderid = radioGender.getCheckedRadioButtonId();

                            radioButton = findViewById(btnid);
                            radioButtonGender = findViewById(btngenderid);
                            ...
                            Toast.makeText(MainActivity.this, "Registration Failed.....Please Check EmailID", Toast.LENGTH_SHORT).show();
                        }
