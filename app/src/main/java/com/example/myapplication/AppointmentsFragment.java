...
public class AppointmentsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        getTextviewaptnew.setTextColor(Color.parseColor("#03a9f4"));
    ...
    public void onChangeTab(int i) {
        if(i == 0){
            ...
            textviewaptview.setTextColor(Color.GRAY);
        ...
        if(i == 1){
            ...
            textviewaptview.setTextColor(Color.parseColor("#03a9f4"));

            getTextviewaptnew.setTextSize(15);
            getTextviewaptnew.setTextColor(Color.GRAY);
